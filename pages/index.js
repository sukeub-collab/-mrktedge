...
const QUOTE_SYMS = [
  ...
  { sym: "NZD_USD",  label: "NZD/USD" },
  { sym: "EUR_GBP",  label: "EUR/GBP" },
  { sym: "EUR_JPY",  label: "EUR/JPY" },
  { sym: "GBP_JPY",  label: "GBP/JPY" },
  { sym: "USD_MXN",  label: "USD/MXN" },
  { sym: "USD_SEK",  label: "USD/SEK" },
  { sym: "USD_NOK",  label: "USD/NOK" },
  { sym: "USD_SGD",  label: "USD/SGD" },
  { sym: "USD_TRY",  label: "USD/TRY" },
  { sym: "USD_ZAR",  label: "USD/ZAR" },
];
