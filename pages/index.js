...
const QUOTE_SYMS = [
  ...
  { sym: "OANDA:USD_MXN", label: "USD/MXN" },
  { sym: "OANDA:USD_SEK", label: "USD/SEK" },
  { sym: "OANDA:USD_NOK", label: "USD/NOK" },
  { sym: "OANDA:USD_SGD", label: "USD/SGD" },
  { sym: "OANDA:USD_TRY", label: "USD/TRY" },
  { sym: "OANDA:USD_ZAR", label: "USD/ZAR" },
];
